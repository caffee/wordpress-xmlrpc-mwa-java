...
/**
 * The enum {@code Overwrite} return boolean flag to determine
 * whether to overwrite an existing content of the same name or leave it. 
 *
 * @author  Lee
 * @version 1.0.0
 * @since   1.0.0
...
public enum Overwrite {
    ...
    private Overwrite (boolean bool) {
        this.bool = bool;
    }
